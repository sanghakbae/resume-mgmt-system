    ...
    <Card className="rounded-[10px] border border-slate-200 bg-white shadow-sm">
      <CardContent className="space-y-3 p-3.5 sm:p-4">
        ...
        <div className="grid gap-3 lg:grid-cols-[288px_minmax(0,1fr)] lg:items-start">
          <FormField label="명함사진" className="h-fit self-start rounded-[10px] border border-slate-200 bg-slate-50/60 p-2.5 shadow-[0_1px_0_rgba(255,255,255,0.85)_inset]">
            <div className="space-y-2">
              ...
              {profile.photo ? (
                <div className="relative mx-auto flex h-40 w-40 items-center justify-center overflow-hidden rounded-[10px] border border-slate-200 bg-slate-100">
                  <img
                    src={profile.photo}
                  ...
                  <div className="pointer-events-none absolute inset-0">
                    <div className="absolute inset-0 rounded-[10px] border-2 border-white/90 shadow-[inset_0_0_0_1px_rgba(15,23,42,0.2)]" />
          ...
          <div className="h-fit self-start rounded-[10px] border border-slate-200 bg-white p-2.5 shadow-[0_1px_0_rgba(255,255,255,0.9)_inset]">
